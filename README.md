...
github:
 https://github.com/Jor515/ProjectoAlgoritmoGrupoC50


# Integrantes del grupo 

 - Barrios Jonathan Ariel
 - Colman Fiorella Soledad
 - Ramirez Lautaro Agustin
 - Zapatero Jorge Ezequiel
...
Tomamos como escenario a un sistema de gestión de pedidos de una servicio de delivery de una pizzeria, donde podemos:
 ...
 - Visualizar estadísticas: cantidad de pedidos por estado, recaudación total, pedidos por zona de entrega y porciones vendidas por tipo de pizza.
...
```bash
    git clone https://github.com/Jor515/ProjectoAlgoritmoGrupoC50.git
```

2. Ingresar a la carpeta del proyecto:
```bash
    cd ProjectoAlgoritmoGrupoC50
```
...
```
   ...
   7. Salir
```
    Seleccionar la opción deseada ingresando el número correspondiente y 
presionando ENTER.

5. Para salir del programa, seleccionar la opción `7`.